#include <iostream>                                                          /*	A��klamalar� yaz sonrada \t ' leri d�zenle   vede girdirdi�in 5 haneli say�y� kontrol ettir   */
...
#include <math.h>
    ...
    #define PAUSE_COMMAND "read -n 1 -s -r -p 'Devam etmek için herhangi bir tuşa basın...'"
#endif
#include <cstring>
#include <iomanip>
#include <string>
...
class Sinif1{
	private:
 string islemno;
 void setislemno(char islemno1);                                                         /*yapcam deerleri private ve protected aldm, bende deiken sadece islemler var*/
	protected:		
	string getislemno();
...
void Sinif1::mutlak(long double sayi1){
    clearScreen();
    double sonuc;
    double sonuc1=-1;
    ...
    do {
        clearScreen();
        cout<<"LUTFEN 5 HANELI ISLEM NO GIRINIZ=";
        cin>>islemno;
...
long double sonuc=1;
	...
	do
	{
		cout<<"LUTFEN 5 HANELI ISLEM NO GIRINIZ=";cin>>islemno; /*kontrol ettirmek i�in 5 haneli mi de�il mi diye (string diye size yapld)*/
	}while(islemno.size()!=5);
		
	
	//islemno.substr(0,5)! deilse yap
	clearScreen();
...
{clearScreen(); 
	...
	do
	{
		cout<<"LUTFEN 5 HANELI ISLEM NO GIRINIZ=";cin>>islemno; /*kontrol ettirmek iin 5 haneli mi deil mi diye (string diye size yapld)*/
	}while(islemno.size()!=5);
	clearScreen();
	double PI=3.14159265;
...
void Sinif2::silme(){
		clearScreen();
				...
				do      								/*kontrol ettirmek iin 5 haneli mi deil mi diye (string diye size yapld)*/
	{
		cout<<"LUTFEN ISLEMIN NOSU OLAN 5 HANELI ISLEM NO'YU GIRINIZ=";
				cin>>islem_sil_no;
				clearScreen();
	...
	if(secim=="2"){
			...
			if(secim3=="1"){
				//do{
					...
					if(secim5=="1"){clearScreen();
						cout<<"1.Sayiyi Giriniz =";cin>>sayi1;cout<<endl;cout<<"2.Sayiyi Giriniz =";cin>>sayi2;
				
						toplama(sayi1,sayi2);
				
					}
					else if(secim5=="2"){clearScreen();

						cout<<"1.Sayiyi Giriniz =";cin>>sayi1;cout<<endl;cout<<"2.Sayiyi Giriniz =";cin>>sayi2;
						cikarma(sayi1,sayi2);
						
					}
					else if(secim5=="3"){clearScreen();
							
						cout<<"1.Sayiyi Giriniz =";cin>>sayi1;cout<<endl;cout<<"2.Sayiyi Giriniz =";cin>>sayi2;
						carpma(sayi1,sayi2);
						
					}
					else if(secim5=="4"){clearScreen();
			...
			else if(secim3=="5"){clearScreen();
					
					cout<<"1.Sayiyi Giriniz(Koku Alinacak Sayi) =";cin>>sayi1;cout<<endl;cout<<"2.Sayiyi Giriniz(Kok Derecesi) =";cin>>sayi2;
				kokalma(sayi1,sayi2);
			}
			else if(secim3=="6"){clearScreen();
